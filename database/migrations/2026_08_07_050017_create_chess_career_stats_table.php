...
return new class extends Migration
{
    ...
    {
        // `games` per spec's column name (Chess uses "Games" instead of "Matches").
        Schema::create('chess_career_stats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('chess_career_stats');
    }
};
