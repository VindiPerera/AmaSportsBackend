...
class StoreJudoProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'career_stats.*.weight_position_id' => ['nullable', 'integer', 'exists:weight_positions,id'],
            'career_stats.*.competition_level_id' => ['nullable', 'integer', 'exists:competition_levels,id'],
            ...
            'recent_fights.*.weight_position_id' => ['nullable', 'integer', 'exists:weight_positions,id'],
            'recent_fights.*.competition_level_id' => ['nullable', 'integer', 'exists:competition_levels,id'],
