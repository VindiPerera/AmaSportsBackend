...
class StoreBasketballProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'career_stats.*.play_position' => ['nullable', 'string', 'max:100'],
            ...
            'career_stats.*.points' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.rebounds' => ['nullable', 'integer', 'min:0'],
            ...
            'recent_matches.*.play_position' => ['nullable', 'string', 'max:100'],
            'recent_matches.*.win' => ['nullable', 'boolean'],
            'recent_matches.*.lost' => ['nullable', 'boolean'],
            'recent_matches.*.points' => ['nullable', 'integer', 'min:0'],
            'recent_matches.*.rebounds' => ['nullable', 'integer', 'min:0'],
            'recent_matches.*.assists' => ['nullable', 'integer', 'min:0'],
            'recent_matches.*.blocks' => ['nullable', 'integer', 'min:0'],
            'recent_matches.*.steals' => ['nullable', 'integer', 'min:0'],
            'recent_matches.*.minutes' => ['nullable', 'integer', 'min:0'],
        ];
    }
}
