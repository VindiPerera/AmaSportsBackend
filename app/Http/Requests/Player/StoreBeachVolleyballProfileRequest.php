...
class StoreBeachVolleyballProfileRequest extends FormRequest
{
    ...
    /**
     * Best-of-3 (spec §D2) — recent-match set columns stop at set_3, unlike
     * indoor Volleyball's set_5.
     *
    ...
    public function rules(): array
    {
        return [
            ...
            'career_stats.*.passes' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.setting' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.serve' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.attacking' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.blocking' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.digging' => ['nullable', 'integer', 'min:0'],
