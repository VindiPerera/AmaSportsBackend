...
class StoreElleProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'career_stats.*.total_balls' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.runs' => ['nullable', 'integer', 'min:0'],
            'career_stats.*.catches' => ['nullable', 'integer', 'min:0'],
            ...
            'recent_matches.*.total_balls' => ['nullable', 'integer', 'min:0'],
